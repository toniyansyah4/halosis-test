...
class BrandController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        DB::commit();
        return successResponse(['brand' => new BrandResource($brand)], 201, 'Brand Success Create');
    }
    ...
    public function update(UpdateRequest $request, $brand)
    {
        ...
        return successResponse(['brand' => new BrandResource($brand)], 200, 'Brand Success Update');
    }
    ...
    public function destroy($brand)
    {
        ...
        return successResponse(['brand' => new BrandResource($brand)], 200, 'Brand Delete');
    }
}
