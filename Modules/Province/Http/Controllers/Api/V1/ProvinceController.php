...
class ProvinceController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        DB::commit();
        return successResponse(['province' => new ProvinceResource($province)], Response::HTTP_CREATED, 'Create Success');
    }
    ...
    public function update(UpdateRequest $request, $province)
    {
        ...
        return successResponse(['province' => new ProvinceResource($province)], Response::HTTP_OK, 'Update Success');
    }
    ...
    public function destroy($province)
    {
        ...
        return successResponse(['province' => new ProvinceResource($province)], Response::HTTP_OK, 'Delete Success');
    }
}
