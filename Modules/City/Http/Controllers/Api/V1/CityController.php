...
class CityController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        DB::commit();
        return successResponse(['city' => new CityResource($city)], Response::HTTP_CREATED, 'Create Success');
    }
    ...
    public function update(UpdateRequest $request, $city)
    {
        ...
        return successResponse(['city' => new CityResource($city)], Response::HTTP_OK, 'Update Success');
    }
    ...
    public function destroy($city)
    {
        ...
        return successResponse(['city' => new CityResource($city)], Response::HTTP_OK, 'Delete Success');
    }
