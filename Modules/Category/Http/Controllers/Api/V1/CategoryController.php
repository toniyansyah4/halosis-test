...
class CategoryController extends Controller
{
    ...
    public function update(UpdateRequest $request, $category)
    {
        ...
        DB::commit();
        return successResponse(['category' => new CategoryResource($category)], Response::HTTP_OK, 'Update Success');
    }
    ...
    public function destroy($category)
    {
        ...
        return successResponse(['category' => new CategoryResource($category)], Response::HTTP_OK, 'Delete Success');
    }
}
